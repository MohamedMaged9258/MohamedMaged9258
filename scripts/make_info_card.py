...
# ===========================================================================
HOST = "mohamed"   # shown as  mohamed@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Mobile App Dev Intern @ DEPI"),
    ("kv", "Prev", "Oracle ERP Consultant @ USE"),
    ("kv", "Focus", "AI Engineering · Software Eng"),
    ("kv", "Edu", "B.Sc Computer Eng, AIU '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Java, Python, C++, Dart, SQL"),
    ("kv", "Mobile", "Flutter, Firebase, Bloc"),
    ("kv", "AI / ML", "FastAPI, Pandas, NumPy, sklearn"),
    ("kv", "DevOps", "Docker, Proxmox, Linux, Git"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "8-thread racing sim — 300% faster than 1 thread"),
    ("bul", "Churn-prediction model at 80% accuracy"),
    ("bul", "Self-hosted home lab: Proxmox, Docker, VPN"),
]
