...
CONTRAST = 1.05
BRIGHTNESS = 1.0
GAMMA = 1.18          # >1 deepens shadows here -> punchy, dramatic face
SHARPEN = False
...
parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">mohamed@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'mohamed@github:~$ whoami <tspan fill="{INK}">Mohamed Maged</tspan></text>')
parts.append(f'<rect x="{PAD+300}" y="{status_y-12:.1f}" width="8" height="14" fill="{INK}">'
